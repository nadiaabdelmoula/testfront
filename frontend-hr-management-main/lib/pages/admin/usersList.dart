...
import 'package:devoteam/pages/admin/user_eval_admin.dart';
...
class _UserListState extends State<UserList> {
  ...
  void initState() {
    ...
    userList = userService.getListUsers(editingController.text);
                                                   ...
                                                   trailing: const Icon(Feather.eye),
                                                    ...
                                                    String str = snapshot.data[index].joinDate;
                                                      ...
                                                      Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                          builder: (context) => UserEvalAdmin(user: UserModel(userId: snapshot.data[index].userId,
    ...
    return Container(
      ...
      child:  TextField(
        ...
        onChanged: (value){
         ...
         setState(() {
           userList = userService.getListUsers(value);
