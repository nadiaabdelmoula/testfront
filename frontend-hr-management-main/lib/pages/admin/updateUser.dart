...
class _State extends State<UpdateUser> {
  ...
  void initState() {
    ...
    exprienceController.text = widget.user.experience;
              ...
              Row(
                ...
                children: [
                  ...
                  MaterialButton(onPressed: (){
                    userService.updateUser(widget.user.username,firstnameController.text, lastnameController.text,
