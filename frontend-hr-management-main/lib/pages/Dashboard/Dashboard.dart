...
class _DashboardState extends State<Dashboard> {
  ...
  @override
  void initState() {
    projetsF = projetService.getProjectsForfait("");
    projetsR = projetService.getProjectsRegie("");
     projetsR.then((value) {
       setState(() {
      ...
      child: Container(
        ...
        child:  TextField(
          ...
          onChanged: (value){
            ...
            setState(() {
              projetsF = projetService.getProjectsForfait(value);
              projetsR = projetService.getProjectsRegie(value);
